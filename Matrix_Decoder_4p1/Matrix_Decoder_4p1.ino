...
*/
// It will determine how a laptop keyboard matrix is wired using a Teensy 4.1 on an FPC daughterboard.
...
//  
int max_pin = 34; // set to the keyboard FPC connector pin count. No need to unsolder the LED on the Teensy. I/O 13 is not used.
...
// ***********Bottom up Test************ 
//
  for (int i=min_pin-1; i<& é -1; i++) {   // outer loop pin (min_pin-1 is typically = 0)
